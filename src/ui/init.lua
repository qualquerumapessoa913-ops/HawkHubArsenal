...
local resizeLabel = Window:CreateLabel(SettingsTab, {
    text = "Resize Keybind: K"
})
local minimizeLabel = Window:CreateLabel(SettingsTab, {
    text = "Minimize Keybind: M"
})

-- Botão: Alterar Keybind de Resize
...
-- Botão: Alterar Keybind de Minimize
Window:CreateButton(SettingsTab, {
